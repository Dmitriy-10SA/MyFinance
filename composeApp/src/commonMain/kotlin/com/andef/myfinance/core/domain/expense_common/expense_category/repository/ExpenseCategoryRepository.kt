package com.andef.myfinance.core.domain.expense_common.expense_category.repository

import com.andef.myfinance.core.domain.expense_common.expense_category.entities.ExpenseCategoryModel
import kotlinx.coroutines.flow.Flow

interface ExpenseCategoryRepository {
    suspend fun addExpenseCategory(expenseCategoryModel: ExpenseCategoryModel)
